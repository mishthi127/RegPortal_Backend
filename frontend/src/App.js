  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/my-competitions" element={<MyRegisteredCompetitions />} />
        {/* <Route path="/registration" element={<CompetitionModal />} /> */}
        {/* <Route path="/competitions/register" element={<CompetitionRegistration />} /> */}
